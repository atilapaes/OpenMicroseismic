...
import om_ped_es_functions, om_ped_es_parameters, om_general_input_data #Defined by user
...
if __name__ == '__main__':
    ...
    for core_counter in range(om_ped_es_parameters.number_of_cores):
        ...
        p = multiprocessing.Process(target=om_ped_es_functions.energy_stack, args=(om_ped_es_parameters.dataset_folder,file_list_for_cores[core_counter][:],core_counter, start_time))
        jobs.append(p)
        p.start()   
############################################################################### 
